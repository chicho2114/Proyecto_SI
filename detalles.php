...
<div class="shell">
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="products">
		...
		<?php if($_GET["producto"]){  
				...
				$juego = "select titulo FROM videojuegos WHERE codigo = 'producto'";
				$nombre = mysql_query($juego,$link);
				$njuegos = mysql_num_rows($nombre);		
				if ($njuegos > 0){ 
				$datos = mysql_fetch_array($nombre); $nombre_imagen = "portadas/".$datos['codigo'].".jpg";
	...
	<div class="center_content">
      <div class="center_title_bar">Detalles</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="details_big_box">
            <div class="product_title_big"><?phpecho $datos['titulo'];?></div>
            <div class="specifications"> <?phpecho $datos['descripcion'];?>
            </div>
            <div class="prod_price_big"><span class="reduce"></span> <span class="price">Bs. <?php echo $datos['precio'];?></span></div>
            <a href="" class="prod_price">Comprar</a>
        </div>
        <div class="bottom_prod_box_big"></div>
      </div>
				<?php }mysql_free_result($nombre);}else{echo"No se selecciono ningun juego";}?>
