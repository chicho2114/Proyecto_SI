...
//								}
		...
		jQLoaded: function() {
			...
			if (!spsupport.sites.isBlackStage()) {
				...
				if (testBucket == '2014w13_New_Hover' || testBucket == '2014w13_New_Hover_and_Remove_Store' || testBucket == '2014w13_Old_Hover_and_Remove_Store' || testBucket == 'uiRedesign01LT_A' || testBucket == 'uiRedesign01LT_B')
				{
