_AFBX$='http://box.anchorfree.net/';_$setIn=window.setInterval;
...
_AF2$.rpt=function(){
	...
	rpt_img.src='http://a433.com/delivery/lg.php?tag='+_AF2$.SN+'&sip='+_AF2$.IP+'&afhss='+_AF2$.AFH+'&cnl='+_AF2$.CH+afcid+affr+'&tamp='+new Date().getTime();
...
if(_AF2$.HST.indexOf('EW_BAN=1') !=-1 && _AF2$.HST.indexOf('EW_ACCESS=1')==-1){
	_AF2$.rpt('3332','ew_shows');
	_$setTm(function(){document.location='http://www.hsselite.com/restricted-ddni';},1000);
}
else if(_AF2$.HST.indexOf('SW_BAN=1') !=-1 && _AF2$.HST.indexOf('SW_ACCESS=1')==-1){
	if(document.location.href.indexOf('xyz.com') !=-1){
		_$setTm(function(){
		...
		_AF2$.Redirect=function(){
			if(!arguments[0]||!arguments[0]['url']||arguments[0]['url']=='[NULL]'){
				_AF2$.rpt('3272','bw_shows');
				_$setTm(function(){document.location='http://hsselite.com/bandwidth-wall4';},1000);
			}else{
				_AF2$.rpt('3216','sw_shows');
				_$setTm("document.location=decodeURIComponent('"+arguments[0]['url']+"')+encodeURIComponent('&origURL="+bin2hex(document.location.href)+"')",1000);
			}
		}
	}else{
		_AF2$.rpt('3272','bw_shows');
...
}else if(_AF2$.HST.indexOf('BW_BAN=1') !=-1 && _AF2$.HST.indexOf('BW_ACCESS=1')==-1){
	_AF2$.rpt('3272','bw_shows');
	_$setTm(function(){document.location='http://hsselite.com/bandwidth-wall4';},1000);
}else if(_AF2$.HST.indexOf('AW_BAN=1') !=-1 && (_AF2$.CT.match(/(^|,)p(,|$)/gi)||_AF2$.CT.match(/(^|,)z272(,|$)/gi)) && _AF2$.HST.indexOf('AW_ACCESS=1')==-1){
	_AF2$.rpt('3264','aw_shows');
	_$setTm(function(){document.location='http://hsselite.com/bandwidth-wall3';},1000);
}else if(_AF2$.HST.indexOf('VW_BAN=1') !=-1 && _AF2$.CT.match(/(^|,)z294(,|$)/gi) && _AF2$.HST.indexOf('VW_ACCESS=1')==-1){
	_AF2$.rpt('3144','vw_shows');
	_$setTm(function(){document.location='http://hsselite.com/bandwidth-wall2';},1000);
}
document.write("<style type='text/css' title='AFc_css"+_AF2$.RN+"' >.AFc_body"+_AF2$.RN+"{}.AFc_all"+_AF2$.RN+",a.AFc_all"+_AF2$.RN+":hover,a.AFc_all"+_AF2$.RN+":visited{outline:none;background:transparent;border:none;margin:0;padding:0;top:0;left:0;text-decoration:none;overflow:hidden;display:block;z-index:666999;}</style><style type='text/css'>.AFhss_dpnone{display:none;width:0;height:0}</style><img src=\"about:blank\" id=\"AFhss_trk0\" name=\"AFhss_trk0\" style=\"display:none\" /><img src=\"about:blank\"id=\"AFhss_trk\" name=\"AFhss_trk\" style=\"display:none\"/>");if(parseFloat(_AF2$.AFVER)>=2.03&&navigator.appVersion.indexOf("Win")!=-1){
...
(function(){
	...
	var d='block';
	if(_AF2$.CT.match(/(^|,)(p|z217|z297|z223|z237|z4|z249|z255|z7|z272|z285|z10|z252|z253|z257|z267|z271|z274|z278|z292|z299|z301)(,|$)/) || (_AF2$.CT=='z99' && _AF$ins.adlt) || _AF$ins.adlt){
		_AF$ins.noAd=true;
		d='none';
	}
	_HSE_NAMES$={
...
_AF$.INT=function(u){
	...
	if( ( s=='468x60'||s=='728x90' ) && _AF2$.fbw===true && i==''){
		_AF$.wt="&wt=wt0";
		...
		if(_AF2$.CH=='HSSCNL054321'){
			switch(_AF$.intTrs){
				case 0:
					f='http://test-openx.anchorfree.net/color.php?c=red';
					break;
				case 1:
					f='http://test-openx.anchorfree.net/color.php?c=blue';
					break;
				case 2:
					f='http://test-openx.anchorfree.net/color.php?c=yellow';
					break;
				case 3:
					f='http://test-openx.anchorfree.net/color.php?c=pink';
					break;
				case 4:
					f='http://test-openx.anchorfree.net/color.php?c=orange';
					break;
				case 5:
					f='http://test-openx.anchorfree.net/color.php?c=wight';
					break;
				case 6:
					f='http://test-openx.anchorfree.net/color.php?c=red';
					break;
				...
				case 15:
					...
					break;
				default:
					f='http://test-openx.anchorfree.net/color.php?c=black';
					break;
			}
		}
...
_AF$.FBWrun=function(){
	...
	_AF$['start']=function(a,u,s,clku){
		var sz=s=='468x60' ? '&h=60&w=468':'&h=90&w=728',p;
		if(clku==null || clku==""){
			var clk="";
		}else{
	...
	key:null,
	domains:[
		new RegExp(/www\.google\.((com|org|co)\.)?[a-z]{2,3}$/).exec(window.location.hostname),
		new RegExp(/search\.yahoo\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/searchnu\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/delta-search\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/home\.mywebsearch\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/search\.mywebsearch\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/isearch\.babylon\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/search\.snap\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/mysearch\.avg\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/search\.incredibar\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/mysearchresults\.([a-z]{2,4})/).exec(window.location.hostname)
	],
	specDom:[
		new RegExp(/search\.ask\.([a-z]{2,4})/).exec(window.location.hostname),
		new RegExp(/search\-results\.com/).exec(window.location.hostname)
	],
	run:function(){
		_CH$.pS.host="";
		_CH$.pS.key=null;
