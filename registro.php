    ...
    <div id="content">
      ...
      <div class="products">
        ...
        <ul>
		      ...
		      <div class="center_title_bar">Registrate</div>
			   <div class="center_prod_box_big">
				<div class="contact_form">
				  <form id="form1" name="form1" method="post" action="registrarse.php">
				    <p>
				    ...
				    <p>
                      ...
                      <input type="text" name="apellido" id="textfield2" />
				    </p>
				    <p>
				      <label for="textfield2">Edad:</label>
                      <input type="text" name="edad" id="textfield2" />
				    </p>
				    <p>
				      <label for="textfield3">Correo:</label>
                      <input name="correo" type="text" required="required" id="textfield3" />
				    </p>
				    <p>
				    ...
				    <p>
                      ...
                      <input name="repassword" type="password" required="required" id="password2" />
				    </p>
				    <p>
				  ...
				  <a href="Login.php">Ya estas registrado? Logeate.</a> 
