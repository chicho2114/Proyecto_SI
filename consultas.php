      ...
      <div class="products">
		...
		<?php if($_GET["opcion"]==1){ 
			 ?> 		<div class="center_content">
				 <div class="center_title_bar">Acción</div>
				<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'accion'";
				...
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
						...
						<div class="prod_details_tab"> <a href="" class="prod_buy">Comprar </a> <a href="detalles.php" class="prod_details">Detalles</a> </div>
					  </div>
		...
		<div class="center_content">	
				 <div class="center_title_bar">Aventura</div>
									<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'aventura'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
		...
		<div class="center_content">
				 <div class="center_title_bar">Deportivos</div>
									<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'deportivos'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){$nombre_imagen = "portadas/".$datos['codigo'].".jpg"; ?> 
					<div class="prod_box">
				...
				<?php if($_GET["opcion"]==4){  ?> 
				<div class="center_content">
				 <div class="center_title_bar">Carreras</div>
									<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'carreras'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
						...
						<div class="prod_details_tab"> <a href="" class="prod_buy">Comprar </a> <a href="detalles.php?producto= <?php echo $datos['codigo'];?>" class="prod_details">Detalles</a> </div>
					</div>
				...
				<?php if($_GET["opcion"]==5){  ?> 
				<div class="center_content">	
				 <div class="center_title_bar">Infantiles</div>
									<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'infantiles'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<?php if($_GET["opcion"]==6){  ?> 
				<div class="center_content">
				 <div class="center_title_bar">Educativos</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'educativos'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<div class="center_content">	
				 <div class="center_title_bar">Rol & RPG</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'rol'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<div class="center_content">
				 <div class="center_title_bar">Estrategia</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'estrategia'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<div class="center_content">
				 <div class="center_title_bar">Terror</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'terror'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<div class="center_content">
				 <div class="center_title_bar">Shooters</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'shooters'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<?php if($_GET["opcion"]==11){  ?> 
				<div class="center_content">	
				 <div class="center_title_bar">Combate</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'combate'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<?php if($_GET["opcion"]==12){  ?> 
				<div class="center_content">
				 <div class="center_title_bar">Simulación</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'simulacion'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
				...
				<?php if($_GET["opcion"]==13){  ?> 
				<div class="center_content">	
				 <div class="center_title_bar">Otros</div>
								<?php 
				require("conexionBD.php"); 
				$sql = "select * FROM videojuegos WHERE categoria = 'otros'";
				$buscar = mysql_query($sql,$link);
				$njuegos = mysql_num_rows($buscar);
				if ($njuegos > 0){ while ($datos = mysql_fetch_array($buscar)){ $nombre_imagen = "portadas/".$datos['codigo'].".jpg";?> 
					<div class="prod_box">
